object Versions {
    ...
    // Platforms
    const val firebasePlatform = "26.2.0"

    // Libs
    const val aboutLibraries = "8.6.5"
    ...
    const val androidXRecyclerViewSelection = "1.1.0-rc03"
    const val androidXRoom = "2.3.0-alpha04"
    const val androidXStartup = "1.0.0"
    const val androidXWorkManager = "2.5.0-beta02"
...
object Libs {
    ...
    const val androidx_hilt_lifecycle_viewmodel = "androidx.hilt:hilt-lifecycle-viewmodel:${Versions.androidXHilt}"
